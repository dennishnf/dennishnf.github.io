...
def convert(pathh):
    ...
    with open(path_out, "a") as myfile:
          timee=strftime("%Y-%m-%d, at %H:%M", gmtime())
          myfile.write("<a href=\"https://dennishnf.com/README.html\" target=\"_blank\">Made from scratch with Python - Powered by Linux</a> <br/>\n")
